...
const styles = theme => ({
  ...
  function getSteps() {
    return ['Übung', 'Tipps zum Vorgehen', 'Lösung'];
  }
  
  function getStepContent(step) {
    switch (step) {
      case 0:
        return `Hier wird die vollständige Übungsaufgabe stehen. Es werden sowohl Hintergrundinformationen als auch zur Lösung notwendige Zahlen genannt.`;
      case 1:
  ...
  class Uebung extends React.Component {
    state = {
      activeStep: 0,
    };
  ...
  export default withStyles(styles)(Uebung);